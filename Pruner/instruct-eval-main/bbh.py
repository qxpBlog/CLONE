...
class BBHData(BaseModel):
    ...
    @classmethod
    def get_config_names(cls, path: str = "/home/iotsc01/zsh/llama_factory_test/instruct-eval/data/lukaemon/bbh") -> List[str]:
        return get_dataset_config_names(path)

    @classmethod
    def load_from_huggingface(
        cls, path: str = "/home/iotsc01/zsh/llama_factory_test/instruct-eval/data/lukaemon/bbh", config: str = "", split: str = "test"
    ):
...
def main(data_dir: str = "/home/iotsc01/zsh/llama_factory_test/instruct-eval/data/lukaemon/bbh", ntrain: int = 3, **kwargs):
