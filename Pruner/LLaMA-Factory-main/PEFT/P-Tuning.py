...
peft_config = PromptEncoderConfig(task_type=TaskType.CAUSAL_LM, num_virtual_tokens=50, encoder_hidden_size=128,encoder_reparameterization_type='LSTM')
...
working_dir = "/home/iotsc01/xinpengq/LLM-Pruner-main/LLaMA-Factory-main/sft_checkpoint_p-tuning"
